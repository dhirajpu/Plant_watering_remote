...
void refreshDisplay(bool force)
{
  ...
  if (showStartupIp)
  {
    ...
    else
    {
      ...
      unsigned long startupWindowStartMs = startupIpUntilMs - STARTUP_IP_SHOW_MS;
      unsigned long elapsedMs = millis() - startupWindowStartMs;
      unsigned long phaseSplitMs = STARTUP_IP_SHOW_MS / 2;
      ...
      {
        snprintf(line1, sizeof(line1), "Ready to use");
        snprintf(line2, sizeof(line2), ":)");
      }
