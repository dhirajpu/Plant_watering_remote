...
$('factoryLoginForm').addEventListener('submit',e=>{e.preventDefault();authenticate()});$('lockBtn').onclick=lock;$('resetBtn').onclick=resetFactory;$('passwordBtn').onclick=changePassword;window.saveNvs=saveNvs;window.calibrate=calibrate;